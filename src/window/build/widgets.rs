...
pub(in crate::window) struct WindowWidgets {
    ...
    pub(in crate::window) password_list_filter_button: MenuButton,
    pub(in crate::window) password_list_filter_popover: Popover,
    pub(in crate::window) password_list_filter_store_box: GtkBox,
    ...
    pub(in crate::window) tools_export_row: ActionRow,
    pub(in crate::window) tools_export_suffix_stack: Stack,
    pub(in crate::window) tools_export_suffix_arrow: Image,
    pub(in crate::window) tools_export_spinner: Spinner,
    ...
    pub(in crate::window) qr_password_button: Button,
    pub(in crate::window) copy_username_button: Button,
    pub(in crate::window) qr_username_button: Button,
    pub(in crate::window) copy_otp_button: Button,
    pub(in crate::window) qr_otp_button: Button,
